...
export const AddProviderModal: FC<AddProviderModalProps> = ({ onClose, editingProvider }) => {
  ...
  const [keyChanged, setKeyChanged] = useState(!editingProvider?.api_key);
      ...
      <div className="bg-white rounded-2xl shadow-large w-full max-w-lg mx-4 overflow-hidden">
        ...
        <div className="px-5 py-4 space-y-3">
          ...
          <div>
            ...
            {!keyChanged && editingProvider?.api_key ? (
              <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-stone-200 bg-stone-50">
                ...
                <span className="text-sm font-mono text-stone-500 tracking-widest flex-1">
                ...
                <button
                  ...
                  className="text-xs text-primary-600 hover:text-primary-800 font-medium transition-colors flex-shrink-0">
                  Change
                </button>
              </div>
            ) : (
