...
const CAPABILITIES: &[Capability] = &[
    ...
    Capability {
        id: "ai_os.provider_manage",
        name: "AI Provider Management",
        domain: "ai_os",
        category: CapabilityCategory::AiOs,
        description: "Add, configure, and manage connections to AI providers including OpenRouter, Claude, OpenAI, Gemini, Ollama, Kilocode, Hermès, and Openclaw. API keys are encrypted at rest with AES-256-GCM.",
        how_to: "AI OS > Add Provider",
        status: CapabilityStatus::Beta,
        privacy: LOCAL_CREDENTIALS,
    },
    Capability {
        id: "ai_os.unified_chat",
        name: "Unified AI Chat",
        domain: "ai_os",
        category: CapabilityCategory::AiOs,
        description: "Chat with any configured AI provider from a single interface with streaming responses, per-message token tracking, and conversation history.",
        how_to: "AI OS > select provider > New chat",
        status: CapabilityStatus::Beta,
        privacy: Some(CapabilityPrivacy {
            leaves_device: true,
            data_kind: PrivacyDataKind::Raw,
            destinations: &["configured AI provider (user-chosen)"],
        }),
    },
    Capability {
        id: "ai_os.model_browser",
        name: "Model Browser",
        domain: "ai_os",
        category: CapabilityCategory::AiOs,
        description: "Discover and select from available models for each provider. Fetches live model lists from Ollama and OpenAI-compatible APIs; uses curated static lists for Anthropic and Google.",
        how_to: "AI OS > chat > model picker",
        status: CapabilityStatus::Beta,
        privacy: Some(CapabilityPrivacy {
            leaves_device: true,
            data_kind: PrivacyDataKind::Metadata,
    ...
    Capability {
        id: "ai_os.conversation_search",
        name: "Conversation Search",
        domain: "ai_os",
        category: CapabilityCategory::AiOs,
        description: "Full-text search across conversation titles and message content stored locally.",
        how_to: "AI OS > Search conversations…",
        status: CapabilityStatus::Beta,
        privacy: LOCAL_RAW,
    },
    Capability {
        id: "ai_os.usage_dashboard",
        name: "Token Usage Dashboard",
        domain: "ai_os",
        category: CapabilityCategory::AiOs,
        description: "Track token consumption and cost per provider over configurable time windows (7d / 30d / 90d).",
        how_to: "AI OS > Usage",
        status: CapabilityStatus::Beta,
        privacy: LOCAL_RAW,
    },
